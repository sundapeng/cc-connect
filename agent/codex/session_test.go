...
func TestBuildExecArgs_IncludesReasoningEffort(t *testing.T) {
	cs, err := newCodexSession(context.Background(), "codex", nil, "/tmp/project", "o3", "high", "full-auto", "", "", nil, "", "", "", nil, nil)
	if err != nil {
...
func TestBuildExecArgs_IncludesBaseURL(t *testing.T) {
	cs, err := newCodexSession(context.Background(), "codex", nil, "/tmp/project", "o3", "high", "full-auto", "", "https://custom.api.example.com", nil, "", "", "", nil, nil)
	if err != nil {
		t.Fatalf("newCodexSession: %v", err)
	}
...
func TestBuildExecArgs_IncludesModelProvider(t *testing.T) {
	cs, err := newCodexSession(context.Background(), "codex", nil, "/tmp/project", "openai/gpt-5.3-codex", "", "full-auto", "", "https://router.example.com/api/v1", nil, "shengsuanyun", "", "", nil, nil)
	if err != nil {
		t.Fatalf("newCodexSession: %v", err)
	}
...
func TestBuildExecArgs_ResumeOmitsCdFlag(t *testing.T) {
	cs, err := newCodexSession(context.Background(), "codex", nil, "/tmp/project", "", "", "full-auto", "thread-abc", "", nil, "", "", "", nil, nil)
	if err != nil {
		t.Fatalf("newCodexSession: %v", err)
	}
...
func TestBuildExecArgs_ModeMapping(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run(tc.mode, func(t *testing.T) {
			cs, err := newCodexSession(context.Background(), "codex", nil, "/tmp/project", "", "", tc.mode, "", "", nil, "", "", "", nil, nil)
			if err != nil {
				t.Fatalf("newCodexSession: %v", err)
			}
...
func TestBuildExecArgs_ResumeUsesSandboxModeConfigOverride(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run(tc.mode, func(t *testing.T) {
			cs, err := newCodexSession(context.Background(), "codex", nil, "/tmp/project", "", "", tc.mode, "thread-abc", "", nil, "", "", "", nil, nil)
			if err != nil {
				t.Fatalf("newCodexSession: %v", err)
			}
			args := cs.buildExecArgs("hi", nil)
...
`
	...
	cs, err := newCodexSession(context.Background(), "codex", nil, workDir, "", "", "", "", "", nil, "", "", "", nil, nil)
	if err != nil {
		t.Fatalf("newCodexSession: %v", err)
	}
	defer cs.Close()
...
func TestRefreshContextUsageFromRollout_UsesLastTokenCount(t *testing.T) {
	...
	cs, err := newCodexSession(context.Background(), "codex", nil, workDir, "", "", "", sessionID, "", []string{"CODEX_HOME=" + codexHome}, "", "", "", nil, nil)
	if err != nil {
		t.Fatalf("newCodexSession: %v", err)
	}
	defer cs.Close()
...
`
	...
	cs, err := newCodexSession(context.Background(), "codex", nil, workDir, "", "", "", "thread-123", "", nil, "", "", "", nil, nil)
	if err != nil {
		t.Fatalf("newCodexSession: %v", err)
	}
	defer cs.Close()
...
`
	...
	cs, err := newCodexSession(context.Background(), "codex", nil, workDir, "", "", "", "thread-stdin", "", nil, "", "", "", nil, nil)
	if err != nil {
		t.Fatalf("newCodexSession: %v", err)
	}
	defer cs.Close()
...
`
	...
	cs, err := newCodexSession(context.Background(), "codex", nil, workDir, "", "", "", "", "", nil, "", "You are Linear Reporter.", "Always invoke linear-bug-intake.", nil, nil)
	if err != nil {
		t.Fatalf("newCodexSession: %v", err)
	}
...
func TestCodexSession_ContinueSessionTreatedAsFresh(t *testing.T) {
	s, err := newCodexSession(context.Background(), "codex", nil, "/tmp", "", "", "full-auto", core.ContinueSession, "", nil, "", "", "", nil, nil)
	if err != nil {
		t.Fatalf("newCodexSession: %v", err)
	}
	defer s.Close()
